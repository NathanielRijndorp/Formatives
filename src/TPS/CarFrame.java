...
public class CarFrame extends JFrame {
     ...
     * @param width - size of the width
     * @param height - size of the length */
    public CarFrame(String title,int width, int height) {
        super(title);
        setWindowSize(width, height);
    }
    /**parameterized constructor : user may set based on preference
    ...
    public CarFrame(String title,int width, int height, boolean visible) {
        super(title);
        setWindowSize(width, height);
        setVisible(visible);
    }
     ...
     */
    public void setCarFrame(String title, int width, int height, boolean visible, int close_operation, boolean resize){
